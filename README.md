...
* [casl-aurelia](https://github.com/stalniy/casl/tree/master/packages/casl-aurelia) ⭐ 7,041 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-19 \* Permissions management plugin which allows to integrate Aurelia and CASL
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 309 | 🐛 0 | 📅 2022-08-18
...
* [ag-grid-aurelia](https://github.com/ag-grid/ag-grid/tree/master/packages/ag-grid-aurelia) ⭐ 15,548 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-19 \* The Aurelia Component for use with ag-Grid, an advanced data grid/data table - [Demo](https://www.ag-grid.com/best-aurelia-data-grid/)
...
* [TypeScript Repository (GitHub)](https://github.com/Microsoft/TypeScript) ⭐ 110,204 | 🐛 5,054 | 🌐 TypeScript | 📅 2026-08-14 Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub)](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,375 | 🐛 675 | 🌐 TypeScript | 📅 2026-08-19 The repository for high quality TypeScript type definitions.
