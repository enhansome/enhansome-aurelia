...
* [casl-aurelia](https://github.com/stalniy/casl/tree/master/packages/casl-aurelia) ⭐ 7,038 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-17 \* Permissions management plugin which allows to integrate Aurelia and CASL
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 309 | 🐛 0 | 📅 2022-08-18
...
* [ag-grid-aurelia](https://github.com/ag-grid/ag-grid/tree/master/packages/ag-grid-aurelia) ⭐ 15,544 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-16 \* The Aurelia Component for use with ag-Grid, an advanced data grid/data table - [Demo](https://www.ag-grid.com/best-aurelia-data-grid/)
...
* [TypeScript Repository (GitHub)](https://github.com/Microsoft/TypeScript) ⭐ 110,185 | 🐛 5,077 | 🌐 TypeScript | 📅 2026-08-14 Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub)](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,372 | 🐛 683 | 🌐 TypeScript | 📅 2026-08-17 The repository for high quality TypeScript type definitions.
