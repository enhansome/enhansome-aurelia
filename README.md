...
* [casl-aurelia](https://github.com/stalniy/casl/tree/master/packages/casl-aurelia) ⭐ 7,033 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-12 \* Permissions management plugin which allows to integrate Aurelia and CASL
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 309 | 🐛 0 | 📅 2022-08-18
...
* [stamp-web/stamp-web-aurelia](https://github.com/stamp-web/stamp-web-aurelia) ⭐ 17 | 🐛 13 | 🌐 JavaScript | 📅 2026-06-24 \* Next Generation Stamp Web Editor written in Aurelio with Bootstrap
...
* [ag-grid-aurelia](https://github.com/ag-grid/ag-grid/tree/master/packages/ag-grid-aurelia) ⭐ 15,537 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-13 \* The Aurelia Component for use with ag-Grid, an advanced data grid/data table - [Demo](https://www.ag-grid.com/best-aurelia-data-grid/)
...
* [TypeScript Repository (GitHub)](https://github.com/Microsoft/TypeScript) ⭐ 110,177 | 🐛 5,082 | 🌐 TypeScript | 📅 2026-08-13 Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub)](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,371 | 🐛 681 | 🌐 TypeScript | 📅 2026-08-14 The repository for high quality TypeScript type definitions.
