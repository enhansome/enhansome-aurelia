...
* [Official GitHub Repo](https://github.com/aurelia/framework) ⭐ 11,672 | 🐛 60 | 🌐 TypeScript | 📅 2023-01-27
...
* [aurelia-template-lint](https://github.com/MeirionHughes/aurelia-template-lint) ⚠️ Archived \* Sanity check of Aurelia-flavor template HTML
* [aurelia-installer](https://github.com/kristianmandrup/aurelia-installer) ⭐ 4 | 🐛 1 | 🌐 JavaScript | 📅 2017-04-01 \* CLI for managing Aurelia components and vendor libs
...
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 311 | 🐛 0 | 📅 2022-08-18
...
* [Aurelia-styleguide](https://github.com/behzad888/Aurelia-styleguide) ⭐ 24 | 🐛 0 | 📅 2017-08-22 \* A starting point for Aurelia development teams to provide consistency through best practices.
...
* [aurelia-mdl](https://github.com/genadis/aurelia-mdl) ⭐ 22 | 🐛 0 | 🌐 HTML | 📅 2017-10-03
* [aurelia-mdl-plugin](https://github.com/arabsight/aurelia-mdl-plugin) ⚠️ Archived \* Material Design Lite plugin for Aurelia

#### Aurelia Plugins

* [casl-aurelia](https://github.com/stalniy/casl/tree/master/packages/casl-aurelia) ⭐ 7,072 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-12 \* Permissions management plugin which allows to integrate Aurelia and CASL
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 311 | 🐛 0 | 📅 2022-08-18
...
* [aurelia-api](https://github.com/SpoonX/aurelia-api) ⚠️ Archived {ES6/TS/Webpack} \* A wrapper around aurelia-fetch-client for multiple endpoints
* [aurelia-breeze](https://github.com/jdanyow/aurelia-breeze) ⭐ 63 | 🐛 13 | 🌐 JavaScript | 📅 2017-01-10 \* Everything you need to use Breeze with Aurelia
* [aurelia-formio](https://github.com/formio/aurelia-formio) ⚠️ Archived \* A dynamic JSON Form Renderer and Form Builder - [See Example](https://formio.github.io/aurelia-formio/)
* [aurelia-bootstrap-plugins](https://github.com/ghiscoding/Aurelia-Bootstrap-Plugins) ⚠️ Archived \* A set of plugins to bridge with 3rd party Bootstrap addons - [Demo](https://ghiscoding.github.io/Aurelia-Bootstrap-Plugins/)
* [aurelia-bs-grid](https://github.com/charlespockert/aurelia-bs-grid) ⭐ 43 | 🐛 31 | 🌐 JavaScript | 📅 2015-12-22 \* Aurelia and Bootstrap powered datagrid control
* [aurelia-google-maps](https://github.com/Vheissu/aurelia-google-maps) ⭐ 43 | 🐛 6 | 🌐 TypeScript | 📅 2023-07-20 \* A highly configurable custom element for use in your Aurelia applications for inserting Google Maps into your application
* [aurelia-notification](https://github.com/SpoonX/aurelia-notification) ⚠️ Archived {ES6/TS/Webpack} \* Automatically translated notifications utilizing humane.js and i18n
* [aurelia-dragula](https://github.com/michaelmalonenz/aurelia-dragula) ⭐ 29 | 🐛 11 | 🌐 JavaScript | 📅 2023-10-16 \* An ES2015 port of the Dragula library, targeted at the Aurelia Framework
* [aurelia-google-analytics](https://github.com/miguelzakharia/aurelia-google-analytics) ⭐ 28 | 🐛 7 | 🌐 JavaScript | 📅 2020-04-28 \* An Aurelia.io plugin that adds Google Analytics page tracking to your project.
* [aurelia-computed](https://github.com/jdanyow/aurelia-computed) ⭐ 25 | 🐛 1 | 🌐 JavaScript | 📅 2016-07-16 \* A plugin for Aurelia to observe computed properties without dirty-checking
* [aurelia-react-loader](https://github.com/bryanrsmith/aurelia-react-loader) ⭐ 25 | 🐛 1 | 🌐 JavaScript | 📅 2018-10-12 \* Load React components directly from Aurelia views
* [aurelia-firebase](https://github.com/pulsarblow/aurelia-firebase) ⭐ 23 | 🐛 6 | 🌐 JavaScript | 📅 2016-07-05 \* [A Firebase plugin for Aurelia](https://aureliaonfire.azurewebsites.net)
* [aurelia-knockout](https://github.com/code-chris/aurelia-knockout) ⭐ 22 | 🐛 4 | 🌐 TypeScript | 📅 2023-02-11 \* A Knockout plugin for Aurelia
* [aurelia-validatejs](https://github.com/aurelia/validatejs) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2016-08-28 {official} \* Enables expressive validation using decorators and/or a fluent API.
...
* [aurelia-polymer](https://github.com/roguePanda/aurelia-polymer) ⭐ 19 | 🐛 11 | 🌐 JavaScript | 📅 2017-02-25 \* Aurelia plugin to support Polymer
* [aurelia-notify](https://github.com/MarcScheib/aurelia-notify) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2017-11-16 \* A notification plugin for Aurelia
* [aurelia-rethink-bindtable](https://github.com/kristianmandrup/aurelia-rethink-bindtable) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2017-04-01 \* Aurelia bind table integration for RethinkDB via Socket.io
* [aurelia-resize](https://github.com/MeirionHughes/aurelia-resize) ⭐ 16 | 🐛 4 | 🌐 TypeScript | 📅 2019-02-05 \* aurelia plugin to observe DOM-element resize events
* [aurelia-grid](https://github.com/corneliutusnea/aurelia-grid) ⚠️ Archived \* A fresh Aurelia Grid written in TypeScript based charlespockert's Aurelia BS Grid
* [aurelia-json-schema-form](https://github.com/jbockle/aurelia-json-schema-form) ⚠️ Archived \* A completely customizable plugin to dynamically generate forms & validate them based on JSON schema
* [aurelia-charts](https://github.com/SpoonX/aurelia-charts) ⚠️ Archived \* Graphs plugin for aurelia. Supports all libraries
* [aurelia-swipeout](https://github.com/michaelbull/aurelia-swipeout) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2017-11-26 \* A custom element for iOS style swipeout actions - [Demo](https://michaelbull.github.io/aurelia-swipeout/)
* [aurelia-fontawesome](https://github.com/jmzagorski/aurelia-fontawesome) ⭐ 12 | 🐛 17 | 🌐 TypeScript | 📅 2023-01-06 \*  Aurelia component for [Font Awesome](https://fontawesome.com/) 5.
* [aurelia-binding-loader](https://github.com/bryanrsmith/aurelia-binding-loader) ⭐ 11 | 🐛 3 | 🌐 JavaScript | 📅 2016-03-23 \* An Aurelia loader for using any module directly from a view template
* [aurelia-split-pane](https://github.com/michaelbull/aurelia-split-pane) ⚠️ Archived \* A custom element for resizable split panes - [Demo](https://michaelbull.github.io/aurelia-split-pane/)
* [aurelia-view-manager](https://github.com/SpoonX/aurelia-view-manager) ⚠️ Archived \* A view manager for aurelia plugins. Add support for overriding views, and multiple frameworks
* [aurelia-tags-input](https://github.com/TGMorais/aurelia-tags-input) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-30 \* An aurelia tags input plugin
* [aurelia-kis-oidc](https://github.com/kisssdev/aurelia-kis-oidc) ⚠️ Archived \* An Aurelia plugin that encapsulates [oidc-client-js library](https://github.com/IdentityModel/oidc-client-js) ⚠️ Archived.
* [aurelia-long-click-event](https://github.com/avrahamcool/aurelia-long-click-event) ⭐ 7 | 🐛 19 | 🌐 JavaScript | 📅 2023-03-04 \* Add delegate/trigger capabilities for long click.
* [aurelia-filter](https://github.com/SpoonX/aurelia-filter) ⚠️ Archived \* A plugin for aurelia to populate search/filter criteria. Works well with aurelia-orm
* [aurelia-cycle](https://github.com/niieani/aurelia-cycle) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2023-12-15 \* An Aurelia plugin that enables the use of Cycle.js inside of Aurelia
* [aurelia-environment](https://github.com/MarcScheib/aurelia-environment) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2017-08-03 \* aurelia-environment provides simple .env parsing and loading
* [aurelia-keyboard-plugin](https://github.com/Novatrox/aurelia-keyboard-plugin) ⚠️ Archived \* Simple keyboard plugin for aurelia
* [aurelia-leaflet](https://github.com/ceoaliongroo/aurelia-leaflet) ⭐ 4 | 🐛 9 | 🌐 JavaScript | 📅 2015-09-16 \* Leaflet Plugin for Aurelia
* [aurelia-yt-player](https://github.com/genadis/aurelia-yt-player) ⚠️ Archived \* Aurelia plugin for Youtube player API
* [abalmus/aurelia-ace-editor](https://github.com/abalmus/aurelia-ace-editor) ⭐ 4 | 🐛 2 | 🌐 JavaScript | 📅 2016-08-14 \* Aurelia ace editor plugin
* [aurelia-view-pipeline](https://github.com/behzad888/aurelia-view-pipeline) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2016-05-05 \* A plugin for loading any Markdown into custom element
* [aurelia-routed-footer](https://github.com/drivesoftware/aurelia-routed-footer) ⭐ 2 | 🐛 11 | 🌐 TypeScript | 📅 2023-01-03 \* An Aurelia plugin which adds the ability to control footer content via the router
* [treacherous-aurelia](https://github.com/grofit/treacherous-aurelia) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2017-01-09 \* An Aurelia plugin for the treacherous validation system
* [Tseberechts/aurelia-place-picker](https://github.com/Tseberechts/aurelia-place-picker) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2016-05-19 \* A place picker inspired by the Autocomplete places with Aurelia
* [aurelia-telemetry](https://github.com/manuel-guilbault/aurelia-telemetry) ⭐ 1 | 🐛 11 | 🌐 TypeScript | 📅 2022-04-09
...
* [aurelia-datatable](https://github.com/SpoonX/aurelia-datatable) ⚠️ Archived \* A 100% aurelia based data table component <http://aurelia-datatable.spoonx.org>
* [stamp-web/stamp-web-aurelia](https://github.com/stamp-web/stamp-web-aurelia) ⭐ 17 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-20 \* Next Generation Stamp Web Editor written in Aurelio with Bootstrap
* [aurelia-tabs](https://github.com/Vheissu/aurelia-tabs) ⭐ 13 | 🐛 3 | 🌐 CSS | 📅 2016-08-23 \* A dependency free tabs component for your Aurelia applications. Allows you to toggle between sections of content, with supports for dynamically composing views with optional data
* [aurelia-animator-tinyanimate](https://github.com/gooy/aurelia-animator-tinyanimate) ⭐ 3 | 🐛 1 | 🌐 JavaScript | 📅 2015-06-05 \* Implementation of the Aurelia base animator using TinyAnimate
* [sukobuto/aurelia-tinymce-sample](https://github.com/sukobuto/aurelia-tinymce-sample) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2015-11-15 \* Sample app with Aurelia and TinyMCE
...
* [ag-grid-aurelia](https://github.com/ag-grid/ag-grid/tree/master/packages/ag-grid-aurelia) ⭐ 15,597 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-11 \* The Aurelia Component for use with ag-Grid, an advanced data grid/data table - [Demo](https://www.ag-grid.com/best-aurelia-data-grid/)
* [aurelia-chart](https://github.com/grofit/aurelia-chart) ⭐ 46 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 \* A chart element for aurelia which is powered by chart js using html5 canvas
...
* [aurelia-identityserver-aspnetcore](https://github.com/paulvanbladel/aurelia-identityserver-aspnetcore) ⭐ 37 | 🐛 1 | 🌐 JavaScript | 📅 2017-02-10 \* Sample integrating aurelia with identityserver 4 and docker
* [aurelia-authentication-loopback-sample](https://github.com/doktordirk/aurelia-authentication-loopback-sample) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-05 \* Aurelia client sample with aurelia-authentication and loopback server (ES6/TS+jspm, ES6+webpack)
* [casl-aurelia-example](https://github.com/stalniy/casl-aurelia-example) ⭐ 5 | 🐛 13 | 🌐 JavaScript | 📅 2026-02-13 \* Example applilcation of authorization in Aurelia app using CASL.
...
* [michaelbull/aurelia-hacker-news](https://github.com/michaelbull/aurelia-hacker-news#aurelia-hacker-news-clone) ⭐ 63 | 🐛 4 | 🌐 TypeScript | 📅 2020-08-25 \* A recreation of the Hacker News website written in TypeScript and built using Aurelia, with webpack as a module bundler.
...
* [electron-aurelia-example](https://github.com/jimschubert/electron-aurelia-example) ⚠️ Archived \* An example desktop application written with Electron and Aurelia.
* [aurelia-electron-webpack](https://github.com/timfish/aurelia-electron-webpack) ⭐ 28 | 🐛 3 | 🌐 TypeScript | 📅 2023-10-05 \* A basic boilerplate to build Electron apps with Aurelia, Typescript, and Webpack.
* [AureliaElectronHappiness](https://github.com/seesharper/AureliaElectronHappiness) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2016-06-23 \* Sample application that shows how to combine TypeScript, VSCode and Electron.
...
* [TypeScript Repository (GitHub)](https://github.com/Microsoft/TypeScript) ⭐ 111,004 | 🐛 5,057 | 🌐 Go | 📅 2026-09-12 Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub)](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,433 | 🐛 694 | 🌐 TypeScript | 📅 2026-09-11 The repository for high quality TypeScript type definitions.
...
* [aurelia-skeleton-navigation-gulp-typescript](https://github.com/Enrapt/aurelia-skeleton-navigation-gulp-typescript) ⭐ 12 | 🐛 1 | 🌐 JavaScript | 📅 2015-05-10 \* Aurelia navigation skeleton implemented with Gulp and Typescript

* [aurelia-axel](https://github.com/cmichaelgraham/aurelia-axel) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2016-03-26 \* As a Visual Studio TypeScript and C# developer building web-based, spatial information systems targeting a variety of platforms that leverage ESRI and SQL Server, I want a starter kit so that I can rapidly build implementations

* [aurelia-axel-northwind](https://github.com/cmichaelgraham/aurelia-axel-northwind) ⭐ 2 | 🐛 3 | 🌐 JavaScript | 📅 2016-06-04 \* As a user, I want a walk through of creating a web app from the `aurelia-axel` starter kit, based of a familiar database (Northwind)

* [aurelia-chrome-extension-seed](https://github.com/PraveenGandhi/aurelia-chrome-extension-seed) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2019-10-01 \* Aurelia chrome extension seed
...
* [**{{** help\_add\_resources **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 311 | 🐛 0 | 📅 2022-08-18

#### ES5 Seed Projects

* [ahmedshuhel/nav-app-es5](https://github.com/ahmedshuhel/nav-app-es5) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2015-01-28 Skeleton that sets up a standard aurelia navigation-style app just using ES5, Bower and RequireJS by @ahmedshuhel.

#### ES5 Examples

* [aurelia-observer-patterns](https://github.com/axwalker/aurelia-observer-patterns) ⭐ 27 | 🐛 0 | 🌐 JavaScript | 📅 2016-04-24 \* Simple examples for different methods of implementing observer patterns in Aurelia
...
* [TsumiNa/meteor-aurelia](https://github.com/TsumiNa/meteor-aurelia) ⭐ 24 | 🐛 4 | 🌐 JavaScript | 📅 2018-06-15 Skeleton that allows Meteor to use Aurelia as the front-end by @TsumiNa.
