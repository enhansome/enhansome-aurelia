...
* [Official GitHub Repo](https://github.com/aurelia/framework) ⭐ 11,670 | 🐛 60 | 🌐 TypeScript | 📅 2023-01-27
...
* [casl-aurelia](https://github.com/stalniy/casl/tree/master/packages/casl-aurelia) ⭐ 7,067 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-10 \* Permissions management plugin which allows to integrate Aurelia and CASL
* [**{{** add\_your\_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md) ⭐ 311 | 🐛 0 | 📅 2022-08-18
...
* [ag-grid-aurelia](https://github.com/ag-grid/ag-grid/tree/master/packages/ag-grid-aurelia) ⭐ 15,591 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-10 \* The Aurelia Component for use with ag-Grid, an advanced data grid/data table - [Demo](https://www.ag-grid.com/best-aurelia-data-grid/)
...
* [TypeScript Repository (GitHub)](https://github.com/Microsoft/TypeScript) ⭐ 110,980 | 🐛 5,039 | 🌐 Go | 📅 2026-09-09 Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub)](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,433 | 🐛 691 | 🌐 TypeScript | 📅 2026-09-09 The repository for high quality TypeScript type definitions.
